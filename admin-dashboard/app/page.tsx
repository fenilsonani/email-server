...
import { Users, Globe, Mail, AlertCircle, Clock, List, ListTodo, CheckCircle2, XCircle, Server } from "lucide-react";
...
function Dashboard() {
  ...
  const statCards = [
    ...
    { label: "Queue Pending", value: stats.queue_pending, icon: ListTodo },
    { label: "Queue Failed", value: stats.queue_failed, icon: AlertCircle },
    { label: "Mailing Lists", value: stats.total_lists, icon: List },
    { label: "Pending Mod.", value: stats.pending_moderation, icon: ListTodo },
  ];
